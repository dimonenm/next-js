...
export const Product = ({ product, className, ...props }: ProductProps): JSX.Element => {
  return (
    <Card className={styles.product}>
      ...
      <div className={styles.raiting}><Rating rating={product.reviewAvg ?? product.initialRating} /></div>
      ...
      <div className={styles.actions}>
        ...
        <Button appearence="ghost" arrow={"right"} className={styles.reviewButton}>Читать отзыва</Button>
      </div>
    </Card>
  )
}